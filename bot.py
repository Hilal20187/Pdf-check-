...
def forensic_pdf_check(file_path):
    ...
    # 1. القاعدة الدقيقة: البحث عن كلمة التعديل الصريحة أو تضارب الإصدارات الحقيقي
    if 'modified using' in producer_lower:
        ...
        risk_score += 50
        evidence.append("⚠️ تم اكتشاف تضارب بين إصدارين مختلفين لمكتبة iText (مثلاً دمج إصدار 7 مع إصدار 5).")
